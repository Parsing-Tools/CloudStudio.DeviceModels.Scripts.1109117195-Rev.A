...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var e = endpoints.addEndpoint("1", "power", endpointType.genericSensor);
  e.variableTypeId = 1072;
  var e = endpoints.addEndpoint("2", "Namespace ID", endpointType.genericSensor);
  e.variableTypeId = 1072;
  var e = endpoints.addEndpoint("3", "Instance ID", endpointType.genericSensor);
  e.variableTypeId = 1072;
}
